    ...
    return (
        <section className="relative isolate overflow-hidden bg-black px-6 py-20 ">
          ...
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            <img className="mx-auto h-60" src="/logo_sem_fundo.png" alt="logo mossorocap" />
            <figure className="mt-10">
              <blockquote className="text-center text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9" style={{ textShadow: '1px 1px 2px black' }}>
                <p>
