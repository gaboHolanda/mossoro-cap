export default function Revendedores(){
    return (
        <div className="relative isolate overflow-hidden p-20" style={{ fontFamily: 'sans-serif' }}>
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                ...
                <div className="lg:pr-4">
                    ...
                    <div className="flex items-center bg-white border-2 border-red-700 border-opacity-70 rounded">
                        <img className="w-10 h-10 rounded-full mr-4" src="/logo.png" alt="Avatar of Jonathan Reinink" />
